...
img_canny = cv2.Canny(img_blur, 102, 178.5)
plt.imshow(img_canny, cmap='gray'), plt.show()



ee_dil = cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (35, 45))
...
elemento_erosion = cv2.getStructuringElement(cv2.MORPH_RECT, (20, 20))
img_er = cv2.erode(img_rellena, elemento_erosion)
plt.imshow(img_er, cmap='gray'), plt.show()

B = cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (40,40))
AoP = cv2.morphologyEx(img_er, cv2.MORPH_OPEN, B)
plt.imshow(AoP, cmap='gray'), plt.show()

B = cv2.getStructuringElement(cv2.MORPH_RECT, (50,40))
AoP = cv2.morphologyEx(img_er, cv2.MORPH_OPEN, B)
plt.imshow(AoP, cmap='gray'), plt.show()
